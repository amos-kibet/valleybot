defmodule ValleybotWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ValleybotWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ValleybotWeb.Gettext, "errors", msg, opts)
    end
  end
